...
scale.x <- scale_x_continuous(breaks = c(seq(min(BC_data$Year), max(BC_data$Year)-6, by = 5), 2022))
...
ggplot(msw, aes(x = Year, y = Disposal_Rate_kg, fill = Population_Category)) +
  ...
  scale_x_continuous(breaks = c(seq(1990, 2015, by = 5), 2022))
```
...
-   Regional district population estimates are sourced from [BC
    ...
    Alberni-Clayoquot, Metro Vancouver, Squamish-Lillooet, Fraser Fort George, Central Kootenay, and East 
...
-   [British Columbia Ministry of Environment and Climate Change Strategy 2024/25 – 2026/27 Service Plan (February 2024) (PDF)](https://www.bcbudget.gov.bc.ca/2022/sp/pdf/ministry/env.pdf)
