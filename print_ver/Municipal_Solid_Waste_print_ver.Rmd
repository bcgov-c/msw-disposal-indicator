...
waste each BC resident sends to a landfill or other disposal site in a
given year.
...
-   Approximately `r round(max_year_total / 1e6, 1)` million tonnes of municipal 
    ...
    recycled.
-   Waste reduction efforts will become more and more important as
...
-   In `r max_year` British Columbians disposed of an
    ...
    waste per person---down `r abs(round(max_year_rate -
    comp_year_rate))` kg per person from `r comp_year`. This
    is a 1 kg/person decrease from the 2017 year. Potential
    reasons for the higher disposal rate in the last two years
    include strong economic activity (e.g. strong real estate
    markets leading to increased building demolition and
    renovation waste, and high tourism) in some regional
    districts.
-   Provincial initiatives which are expected to decrease waste disposal
    rates despite strong economic cycles include the Plastics Action
    Plan, [organics
    ...
    responsibility](https://www2.gov.bc.ca/gov/content/environment/waste-management/recycling/product-stewardship) programs.
...
disposed of in 2018 for each regional district and the province as a
...
-   Regional District population estimates are sourced from [BC
    ...
    Squamish-Lillooet, Alberni-Clayoquot, Bulkley-Nechako and East
    Kootenay population estimates have been adjusted based on data
    submitted by the Regional Districts.
-   Disposal rates for Comox Valley and Strathcona are reported as one
    as they handle their waste
    stream [together](http://www.cswm.ca/index.html).
...
-   ^1^[British Columbia Ministry of Environment and Climate Change
    Strategy 20120/21 -- 2022/23 Service Plan (February 2019)
    (PDF)](https://www.bcbudget.gov.bc.ca/2020/sp/pdf/ministry/env.pdf)
...
Published and Available On-Line at Environmental Reporting BC (August 2020):
