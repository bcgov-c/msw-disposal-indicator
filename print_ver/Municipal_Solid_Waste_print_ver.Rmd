...
-   Provincial initiatives which support decreases in waste disposal
    ...
    responsibility (recycling)](https://www2.gov.bc.ca/gov/content/environment/waste-management/recycling/extended-producer-responsibility) programs, and funding for organics infrastructure and collection.
-   Variability in disposal rates from one region to the next is
    ...
    disposal rate data do not tell the whole story, they are useful in
...
-   [British Columbia Ministry of Environment and Climate Change
    Strategy 2021/22 -- 2023/24 Service Plan (April 2021)
    (PDF)](https://www.bcbudget.gov.bc.ca/2021/sp/pdf/ministry/env.pdf)
